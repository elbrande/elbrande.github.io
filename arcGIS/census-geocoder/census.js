...
bbbMap.getLayerConfig = () => {
   ...
   bbbMap._config.layers.push ({layerId:0,id:bbbMap.censusTractID,title:"Census Tracts",objectIdField:"OBJECTID",outFields:["*"],popupEnabled:1,legendEnabled:1,visible:1,renderer:{type:"simple",symbol:{type:"simple-fill",outline:{width:0.5,color:[250,255,255,0.50]},color:[20,130,200,0.35]}}});
...
require([
      ...
      (async () => {
       ...
       bbbMap.view = new MapView({
         ...
         reactiveUtils.on(
            () => bbbMap.view.popup, "trigger-action",
            (e) => {
         ...
         reactiveUtils.when(()=> bbbMap.view.popup.selectedFeature, (feature) => {
